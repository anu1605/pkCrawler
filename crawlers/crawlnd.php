...
for ($edition = 0; $edition < count($paperArray); $edition++) {
    ...
    for ($i = 1; $i <= $a; $i++) {
        ...
        // $filepath = "/var/www/d78236gbe27823/marketing/Whatsapp2/images/ND_" . $paperArray[$edition] . "_" . $filenamedate . "_" . $number . "_admin_hin.jpg";

        $filepath = dirname(__FILE__) . "/images/ND_" . $paperArray[$edition] . "_" . $filenamedate . "_" . $number . "_admin_hin.jpg";
        $number++;
        $t2 = time();
