...
<body>
    ...
    <div>
        ...
        <a href="javascript:void(0)" onclick="clear_jps_folder()" class='btn btn-primary' style="float:right;">Clear jps Folder</a>
    </div>
    ...
    <form method="POST" action="display_jps_pages.php" id="submit_form">
        ...
        <input type="hidden" name="paper" value="jps">
    ...
    <script>
        ...
        function clear_jps_folder() {
            $("#action").val('Clear_jps_image_folder');
        ...
        function initCropper(image_name, filename) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    $("#loader").fadeOut();
                    var image_url = './paper_images/' + filename;
