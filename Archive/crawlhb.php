...
for ($edition = 0; $edition < count($cityArray); $edition++) {
    ...
    for ($imglink = 1; $imglink < count($linkArray); $imglink++) {
        ...
        // $filepath = "/var/www/d78236gbe27823/marketing/Whatsapp2/images/HB_" . ucwords($cityArray[$edition]) . "_" . $date . "_" . $number . "_admin_hin.jpg";

        $filepath = dirname(__FILE__) . "/images/HB_" . ucwords($cityArray[$edition]) . "_" . $date . "_" . $number . "_admin_hin.jpg";
        $number++;
