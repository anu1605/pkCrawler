...
for ($edition = 0; $edition < count($cityarray); $edition++) {
    ...
    for ($page = 1; $page < 50; $page++) {
        ...
        if (file_get_contents($imagelink)) {
            // $filepath = "/var/www/d78236gbe27823/marketing/Whatsapp2/images/RS_" . $cityarray[$edition] . "_" . $filenamedate . "_" . $number . "_admin_hin.jpg";
            $filepath = dirname(__FILE__) . "/images/RS_" . $cityarray[$edition] . "_" . $filenamedate . "_" . $number . "_admin_hin.jpg";
            $number++;
            $t2 = time();
