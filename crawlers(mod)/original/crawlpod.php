...
$starttime = time();
echo date('Y-m-d H:i:s', time() + (5.5 * 3600)) . "=>Starting POD\n";

for ($i = 1; $i < count($contentArray); $i++) {
    $imagelink =  str_replace("&", "&amp;", explode('"',  $contentArray[$i])[0]);


    $filepath = "/nvme/POD_Bhubaneswar" . "_" . $date . "_" . $i . "_ori.jpg";
    $temp_txtfile = str_replace(".jpg", "", $filepath);
    $txtfile = "./imagestext/POD_Bhubaneswar" . "_" . $date . "_" . $i . "_ori.txt";
