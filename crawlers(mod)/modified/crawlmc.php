...
// $finddateq = "Select * from Crawl_Record WHERE Papershortname='MC' ORDER BY Paperdate DESC LIMIT 1";
...
echo date("d", time()) - date("d", strtotime($filenamedate));
// if(date("d", time()) - date("d", strtotime($filenamedate)))
