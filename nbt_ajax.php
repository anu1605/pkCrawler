...
if ($_POST['action'] == 'Clear_nbt_image_folder') {
...
if ($_POST['action'] == 'upload_images_on_server') {
    ...
    if ($response and file_put_contents("/var/www/d78236gbe27823/marketing/Whatsapp2/nbt_images/" . $_POST['file_name'], $response)) {
        echo "Success";
    } else return false;
}
