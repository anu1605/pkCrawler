...
<body>
	...
	<div>
		...
		<a href="javascript:void(0)" onclick="clear_jagran_folder()" class='btn btn-primary' style="float:right;">Clear Jagran Folder</a>
	</div>
	...
	<form method="POST" action="display_jagran_pages.php" id="submit_form">
	...
	<script>
		...
		function clear_jagran_folder()
		{
			$("#action").val('Clear_jagran_image_folder');
		...
		function initCropper(image_name,filename){
		    ...
		    $.ajax({
				...
				success: function(response) {
					var image_url ='./jagran_images/'+filename;
